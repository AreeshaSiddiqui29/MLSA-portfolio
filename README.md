...
const siteProps = {
  ...
  title: "CyberSecuritu Enthusiast/ CyberSec Analyst",
  email: "Areesha.Siddiqui@studentambassadors.com",
  gitHub: "AreeshaSiddiqui29",
  instagram: "areeshas",
  linkedIn: "Areesha Siddiqui",
  medium: "",
  twitter: "CyberArtist313",
  youTube: "UBIT CyberConnect",
};
```
